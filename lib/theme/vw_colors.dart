...
class VwColors {
  ...
  static const Color success = Color(0xFF00A483);
  static const Color successComplement = Color(0xFFD9F2ED);

  static const Color background = Color(0xFF1D1D1F);
  static const Color backgroundDetail = Color(0xFFF2F2F2);
